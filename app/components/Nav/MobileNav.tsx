...
function MobileNavItem({
	...
	return (
		<li className="border-b border-slate-200 py-4 last:border-0 focus:bg-slate-300 dark:focus:bg-violet-500">
...
export function MobileNav({
	...
	return (
		<dialog
			className="backdrop:bg-gray-900/50 z-50 w-5/6 rounded-2xl bg-slate-100 px-4 py-6 backdrop:backdrop-blur-sm dark:bg-violet-700"
			onClick={handleClick}
			ref={ref}
		>
			<div id="mobile-nav">
