...
var require_client = __commonJS({
  "node_modules/.pnpm/mdx-bundler@9.2.1_esbuild@0.18.13/node_modules/mdx-bundler/dist/client.js"(exports) {
    ...
    exports.getMDXExport = getMDXExport2;
    ...
    function getMDXComponent2(code, globals) {
      return getMDXExport2(code, globals).default;
    }
    function getMDXExport2(code, globals) {
      let scope = {
        React,
        ReactDOM,
        _jsx_runtime,
...
init_define_process_env_REMIX_DEV_HTTP_ORIGIN();
var import_react9 = require("@remix-run/react"), import_remix_development_tools = require("remix-development-tools");

// node_modules/.pnpm/remix-development-tools@1.0.6_@types+react-dom@18.2.7_@types+react@18.2.15_react-dom@18.2.0_react@18.2.0/node_modules/remix-development-tools/dist/stylesheet.css
var stylesheet_default = "/build/_assets/stylesheet-4MWGXHUP.css";

// app/assets/css/tailwind.css
var tailwind_default = "/build/_assets/tailwind-ZHM6BFYQ.css";
...
function App() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("html", { lang: "en", className: "h-full", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("body", { className: "h-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "bg-slate-100 dark:bg-zinc-900", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(import_remix_development_tools.RemixDevTools, {}, void 0, !1, {
        fileName: "app/root.tsx",
        lineNumber: 41,
        columnNumber: 6
      }, this)
...
// app/utils/mdx.server.ts
var import_mdx_bundler = __toESM(require_dist2()), import_client = __toESM(require_client2());
...
function addMetaData(post, pathToFile) {
  let { banner } = (0, import_client.getMDXExport)(post.code);
  return {
    ...post,
...
function ArticleCard({ post }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { className: "flex flex-col gap-x-6 gap-y-4 py-4 md:rounded-md md:border md:border-slate-200 md:p-6 md:py-8 dark:md:border-pink-300/40 lg:px-8 lg:first:col-span-2", children: [
    ...
    post.banner && /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(
      "img",
      {
        src: post.banner,
...
init_define_process_env_REMIX_DEV_HTTP_ORIGIN();
var import_client2 = __toESM(require_client2()), import_react11 = require("react"), import_remix_typedjson2 = require("remix-typedjson");

// app/assets/css/article.page.css
var article_page_default = "/build/_assets/article.page-4NMERW5I.css";
...
var import_jsx_dev_runtime11 = require("react/jsx-dev-runtime"), links2 = () => [
  ...
  {
    rel: "stylesheet",
    href: article_page_default
  }
];
async function loader2({ params }) {
  if (!params.slug)
    throw new Error("Slug not found");
  let { code, frontmatter: frontmatter2, readTime, banner } = await getMdxContent(
    params.slug
  );
  return (0, import_remix_typedjson2.typedjson)({ code, frontmatter: frontmatter2, readTime, banner });
}
function BlogPostPage() {
  let { code, frontmatter: frontmatter2, readTime, banner } = (0, import_remix_typedjson2.useTypedLoaderData)(), Component = (0, import_react11.useMemo)(() => (0, import_client2.getMDXComponent)(code), [code]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("article", { className: "article grid gap-4 px-4 md:gap-y-6 md:px-6 lg:px-8", children: [
    ...
    banner && /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(
      "img",
      {
        src: banner,
        alt: `Banner for ${frontmatter2.title}`,
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("div", { className: "flex flex-col gap-y-2 overflow-hidden dark:text-slate-200 md:gap-y-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(Component, {}, void 0, !1, {
      fileName: "app/routes/articles.$slug.tsx",
      lineNumber: 57,
      columnNumber: 5
    }, this) }, void 0, !1, {
  ...
  return (await Promise.all(
    files.map(async (file) => {
      ...
      if (import_fs.default.existsSync(filePath)) {
        let { frontmatter: frontmatter2, code } = await getMdxContentForFile(filePath);
        return { post: { frontmatter: frontmatter2, code }, file: filePath };
      }
      return null;
    })
...
async function getLatestArticle() {
  ...
  return allArticles.sort((a, b) => a.post.frontmatter.date > b.post.frontmatter.date ? -1 : 1), addMetaData(allArticles[0].post, allArticles[0].file);
}
...
function LatestArticle({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)("section", { className: "grid px-4 py-8 md:px-6 lg:grid-cols-2 lg:grid-rows-[auto_auto_1fr_auto_auto] lg:px-8", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)(import_react12.Link, { to: `/article/${slug}`, className: "lg:col-start-2 lg:mt-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)("h2", { className: "font-heading text-2xl text-slate-700 dark:text-slate-200", children: latestArticle.title }, void 0, !1, {
    ...
    banner && /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)(
      "img",
      {
        src: banner,
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)("p", { className: "mt-6 text-slate-400 lg:col-start-2 lg:mt-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)(PostMeta, { date: latestArticle.date, readTime }, void 0, !1, {
      fileName: "app/routes/_index/components/LatestArticle.tsx",
      lineNumber: 36,
      columnNumber: 5
    }, this) }, void 0, !1, {
...
async function loader3() {
  let post = await getLatestArticle();
  return (0, import_remix_typedjson3.typedjson)({ post });
}
function Index() {
  let { post } = (0, import_remix_typedjson3.useTypedLoaderData)();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "flex flex-col lg:gap-4", children: [
    ...
    post && /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(
      LatestArticle,
      {
...
init_define_process_env_REMIX_DEV_HTTP_ORIGIN();
var assets_manifest_default = { entry: { module: "/build/entry.client-BLRHY2KK.js", imports: ["/build/_shared/chunk-BA6NHEY4.js", "/build/_shared/chunk-H5ZE7JVG.js", "/build/_shared/chunk-5AUE62GW.js", "/build/_shared/chunk-SE6AVHRO.js", "/build/_shared/chunk-LSXLK3Z7.js", "/build/_shared/chunk-K6PKGSTD.js", "/build/_shared/chunk-O4OKU2LD.js", "/build/_shared/chunk-PNG5AS42.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-KPFMP353.js", imports: ["/build/_shared/chunk-EFRDSWSW.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-XRDVBC7I.js", imports: ["/build/_shared/chunk-VZLROKTT.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/about": { id: "routes/about", parentId: "root", path: "about", index: void 0, caseSensitive: void 0, module: "/build/routes/about-AGNWWJMB.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/articles.$slug": { id: "routes/articles.$slug", parentId: "root", path: "articles/:slug", index: void 0, caseSensitive: void 0, module: "/build/routes/articles.$slug-F3L5Y4GJ.js", imports: ["/build/_shared/chunk-ZO7RYJJ4.js", "/build/_shared/chunk-VZLROKTT.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/articles._index": { id: "routes/articles._index", parentId: "root", path: "articles", index: !0, caseSensitive: void 0, module: "/build/routes/articles._index-QC5QOMIR.js", imports: ["/build/_shared/chunk-ZO7RYJJ4.js", "/build/_shared/chunk-VZLROKTT.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/courses": { id: "routes/courses", parentId: "root", path: "courses", index: void 0, caseSensitive: void 0, module: "/build/routes/courses-RRPUVSBJ.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/speaking": { id: "routes/speaking", parentId: "root", path: "speaking", index: void 0, caseSensitive: void 0, module: "/build/routes/speaking-X4ZI6IZT.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/uses": { id: "routes/uses", parentId: "root", path: "uses", index: void 0, caseSensitive: void 0, module: "/build/routes/uses-HFKEY256.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, version: "6d4ed3ca", hmr: { runtime: "/build/_shared/chunk-LSXLK3Z7.js", timestamp: 1689631361486 }, url: "/build/manifest-6D4ED3CA.js" };
