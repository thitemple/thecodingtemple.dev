...
The are two special things we added:

1) Was the `div` with an id of `real-world-fable-app`.
2) The script tag pointing to bundle.js file that will be generated by Webpack.
