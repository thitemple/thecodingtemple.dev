...
description:
  How to use the language-ext library to handle nulls in C# in an effective and
  safe manner
category: code
date: 2017-01-31
tags:
  ...
  - language extensions
comments: true
slug: handling-nulls-in-csharp-the-right-way
summary:
  Learn how to handle null values in C# effectively using the language-ext
...
You know that, just by reading _public Option\<Movie> GetById(int id)_ that this
