...
<div style={{maxWidth: 854}}><div style={{position:'relative',height:0,paddingBottom: '56.25%'}}><iframe src="https://embed.ted.com/talks/ben_dunlap_talks_about_a_passionate_life" width="854" height="480" style={{position:'absolute',left:0,top:0,width:'100%', height: '100%'}} frameBorder="0" scrolling="no" allowfullscreen></iframe></div></div>
