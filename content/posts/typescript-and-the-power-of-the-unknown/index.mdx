...
tags:
  - code
  - typescript
slug: typescript-and-the-power-of-the-unknown
summary:
  Uncover the power of TypeScript's 'unknown' type, a safer alternative to
...
function printMovie(movie: unknown) {
	console.log(
		`The movie title is ${movie.title} and its rating is ${movie.rating}`,
	);
}
```
