...
export default function AboutPage() {
	return (
		<article className="flex flex-col items-center gap-4 px-4 md:px-6 lg:px-8">
			<img src={me} alt="Me" className="h-52 w-52 rounded-full" />
			<Title>Hi, I'm Thiago Temple</Title>
			<div className="flex flex-col gap-y-4 text-slate-600 dark:text-slate-300 lg:gap-y-6">
				<p>
				...
				<div>
					...
					<p>
						...
						family purchased our first computer. At the age of 13, I would
						utilize my neighbor's computer. Today, I am passionate about the art
						of software development and thrive on the challenge of staying
						updated with the latest technologies. The constant evolution of
						technology is a major driving force for me, along with the knowledge
						that the software I help build contributes to enhancing people's
						productivity.
					</p>
				</div>
				<div>
					...
					<p>
						...
						what I am learning. As the saying goes, teaching others is one of
						the most effective ways to solidify one's understanding. Or even if
						I am not teaching anyone, I am documenting for my future self.
				...
				<div>
					...
					<p>
						However, one thing I cherish the most is spending quality time with
						my family. I am married and a proud father of a two kids, as well as
						the owner of two very active greyhounds.
					</p>
				</div>
			</div>
		</article>
